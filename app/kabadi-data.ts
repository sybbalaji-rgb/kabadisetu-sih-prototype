import { Handshake, Home, Plus, ShieldAlert, WalletCards } from "lucide-react";

export type Role = "collector" | "recycler";
export type CollectorView = "home" | "create" | "matches" | "ledger" | "safety";
