...
import {
  ...
  Scale, ShieldAlert, ShieldCheck, Sparkles, Truck, UploadCloud, UsersRound, WalletCards,
} from "lucide-react";
...
export function CollectorWorkspace(props: CollectorProps) {
  ...
  if (props.view === "ledger") return <EarningsLedger lots={props.lots} paidTotal={props.paidTotal} pendingTotal={props.pendingTotal} onSelectLot={props.onSelectLot} />;
...
function EarningsLedger({ lots, paidTotal, pendingTotal, onSelectLot }: { lots: Lot[]; paidTotal: number; pendingTotal: number; onSelectLot: (id: string) => void }) {
